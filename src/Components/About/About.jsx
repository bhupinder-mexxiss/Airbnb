...
const About = () => {
  return (
    <>
      <div className="relative bg-[#000929] py-20">
        <div className="container mx-auto">
          <div className="lg:flex justify-between gap-4 text-center ">
          ...
          <div className="grid lg:grid-cols-2 gap-8 my-8 sm:my-12">
            <div className="bg-white bg-opacity-20 rounded-3xl p-6 md:p-8">
              <div className="flex flex-col sm:flex-row gap-5 md:gap-[30px]">
                <div className="min-w-16 w-16 h-16 md:min-w-20 md:w-20 md:h-20 rounded-full flex items-center justify-center bg-secondary">
